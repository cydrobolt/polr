...
$app->group(['prefix' => '/api/v2', 'namespace' => 'App\Http\Controllers'], function ($app) {
	...
	$app->get('action/listLinks', ['as' => 'api_list_links_url', 'uses' => 'Api\ApiLinksController@listLinks']);
	$app->post('action/updateLinks', ['as' => 'api_update_links_url', 'uses' => 'Api\ApiLinksController@updateLinks']);
});
